...
import realworld.ui.feed.FeedEvent.OnArticleClicked
import realworld.ui.feed.FeedEvent.OnArticlesClicked
import realworld.ui.feed.FeedEvent.OnArticlesFeedClicked
import realworld.ui.feed.FeedEvent.OnArticlesLoadFailed
import realworld.ui.feed.FeedEvent.OnArticlesLoaded
import realworld.ui.feed.FeedEvent.OnCreateArticleClicked
import realworld.ui.feed.FeedEvent.OnLoadMore
import realworld.ui.feed.FeedEvent.OnRefresh
import realworld.ui.feed.FeedEvent.OnSigninClicked
import realworld.ui.feed.FeedEvent.OnUserAuthChanged
  ...
  model.refreshing -> {
    next(
      model.copy(
        ...
        hasMorePages = event.articles.size >= ARTICLE_LIMIT
      ), emptySet<Any>()
    )
  }
  else -> {
